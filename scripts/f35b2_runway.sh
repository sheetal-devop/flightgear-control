...
#Usage: ./f35b2_runway.sh START_PORT_RANGE NAME
...
DISPLAY=$DISPLAY_STR FG_HOME=$FG_HOME_DIR $APPIMAGE_FILE\
 ...
 --airport=CYVR\
 --fg-root=$FG_ROOT_DIR\
 --generic=socket,out,45,$TELEM_HOST,$TELEM_OUTPUT_PORT,udp,f35b2_output\
 --generic=socket,in,45,$INPUT_HOST,$CONSUMABLES_INPUT_PORT,udp,f35b2_input_consumables\
 --generic=socket,in,45,$INPUT_HOST,$CONTROLS_INPUT_PORT,udp,f35b2_input_controls\
 --generic=socket,in,45,$INPUT_HOST,$ENGINES_INPUT_PORT,udp,f35b2_input_engines\
 --generic=socket,in,45,$INPUT_HOST,$FDM_INPUT_PORT,udp,f35b2_input_fdm\
 --generic=socket,in,45,$INPUT_HOST,$ORIENTATION_INPUT_PORT,udp,f35b2_input_orientation\
 --generic=socket,in,45,$INPUT_HOST,$POSITION_INPUT_PORT,udp,f35b2_input_position\
 --generic=socket,in,45,$INPUT_HOST,$SIM_INPUT_PORT,udp,f35b2_input_sim\
 --generic=socket,in,45,$INPUT_HOST,$SIM_FREEZE_INPUT_PORT,udp,f35b2_input_sim_freeze\
 --generic=socket,in,45,$INPUT_HOST,$SIM_MODEL_INPUT_PORT,udp,f35b2_input_sim_model\
 --generic=socket,in,45,$INPUT_HOST,$SIM_SPEEDUP_INPUT_PORT,udp,f35b2_input_sim_speedup\
 --generic=socket,in,45,$INPUT_HOST,$SIM_TIME_INPUT_PORT,udp,f35b2_input_sim_time\
 --generic=socket,in,45,$INPUT_HOST,$SYSTEMS_INPUT_PORT,udp,f35b2_input_systems\
 --generic=socket,in,45,$INPUT_HOST,$VELOCITIES_INPUT_PORT,udp,f35b2_input_velocities\
 --telnet=$TELNET_PORT\
 --log-dir=$LOG_DIR\
 --disable-ai-traffic\
 --disable-sound\
