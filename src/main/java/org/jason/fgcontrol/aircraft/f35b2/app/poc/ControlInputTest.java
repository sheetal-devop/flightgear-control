package org.jason.fgcontrol.aircraft.f35b2.app.poc;
...
public class ControlInputTest {
    ...
    private final static int FG_SOCKETS_ORIENTATION_INPUT_PORT = 10007;
    ...
    public ControlInputTest() throws FlightGearSetupException, SocketException, UnknownHostException {
        ...
        F35B2Config config = new F35B2Config();
        
        config.setTelemetryOutputPort(10000);
        config.setOrientationInputPort(10007);
        
        plane = new F35B2( config );
