...
/**
 * Config class for F15C flight parameters with largely-proven default values.
 * 
 * @author jason
 *
 * TODO: sanity check as many parameters as possible
 */
public class F15CFlightParameters extends AircraftFlightParameters {
    ...
    private final static int STABILIZATION_CYCLE_COUNT = 20;
    private final static long STABILIZATION_CYCLE_SLEEP = 5L;
    
    public F15CFlightParameters() {
    	super();
    }
