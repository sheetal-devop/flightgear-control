...
public class WaypointFlightFleet {
    ...
    public static void main(String [] args) {
        ...
        waypointManager.setWaypoints( KnownRoutes.VANCOUVER_SHORT_TOUR );
//        targetAltitude = 6000;
//        flightMixture = 0.93;
//        flightThrottle = 0.93;
...
//        waypointManager.setWaypoints( reverseOrder );
        ...
        try {
        	...
        	String confFile = "./c172p.properties";
        	if(args.length >= 1) {
        		confFile = args[0];	
        	}
        	...
        	C172PConfig c172pConfig = new C172PConfig(simProperties); 
