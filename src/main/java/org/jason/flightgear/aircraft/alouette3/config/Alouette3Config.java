package org.jason.flightgear.aircraft.alouette3.config;

//TODO: refactor with changes to FlightGearPlane host/port configuration
public class Alouette3Config {
    ...
    public Alouette3Config() {
        this(FG_TELNET_DEFAULT_HOST, FG_TELNET_DEFAULT_PORT, FG_SOCKETS_DEFAULT_HOST, FG_SOCKETS_TELEM_DEFAULT_PORT);
    }
    
    public Alouette3Config(String telnetHostname, int telnetPort, String socketsHostname, int socketsPort) {
        super();
