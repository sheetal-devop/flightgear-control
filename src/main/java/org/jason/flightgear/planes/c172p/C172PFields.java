...
public abstract class C172PFields {
	...
	public final static String BATTERY_SWITCH_TRUE = "1";
	public final static String BATTERY_SWITCH_FALSE = "0";
	...
	//common values for these fields
	public final static String GEAR_DOWN_TRUE = "1";
	public final static String GEAR_DOWN_FALSE = "0";
	...
	//common values for these fields
	public final static String ENGINE_RUNNING_TRUE = "1";
	public final static String ENGINE_RUNNING_FALSE = "0";
	...
	//common values for these fields
	public final static String FDM_DAMAGE_REPAIRING_TRUE = "1";
	public final static String FDM_DAMAGE_REPAIRING_FALSE = "0";
	...
	//common values for these fields
	public final static String FDM_DAMAGE_ENABLED_TRUE = "1";
	public final static String FDM_DAMAGE_ENABLED_FALSE = "0";
	...
	//common values for these fields
	public final static String SIM_PARKING_BRAKE_TRUE = "1";
	public final static String SIM_PARKING_BRAKE_FALSE = "0";
	...
	//common values for these fields
	public final static String SIM_FREEZE_TRUE = "1";
	public final static String SIM_FREEZE_FALSE = "0";
