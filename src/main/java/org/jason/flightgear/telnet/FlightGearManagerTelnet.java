...
public class FlightGearManagerTelnet {
	...
	private Logger logger = LoggerFactory.getLogger(FlightGearManagerTelnet.class);
	...
	//one-liner script
	public void runNasal(String line) {
		runNasal( new String[] {line} );
	}

	//multi-line script
	public void runNasal(String[] lines) {
...
//	}
	...
	public String sendCommandReadRawOutput(String command) {
